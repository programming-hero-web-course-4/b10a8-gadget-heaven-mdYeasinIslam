            ...
            <div>
                {
                    showComponent ?
                        <>
                <div className="flex justify-between items-center px-2 lg:px-0 py-8 max-w-5xl mx-auto">
                    <h1 className="text-xl font-semibold">Cart</h1>
                     <div className="lg:flex items-center space-y-2  gap-3">
                    <h3 className="font-semibold">Total cost : $<span>{calculateTotal.toFixed(3)}</span></h3>

                     <button onClick={() => sortingFunction(true)} className="mr-3 btn btn-sm outline outline-1 outline-[#9538E2] text-[#9538E2] duration-500 hover:bg-[#9538E2] hover:text-white">Sort by Price</button>
                 ...
                 <div className="space-y-5 ">
                    ...
                    <div className="py-8 max-w-5xl mx-auto">
                                <h1 className="text-xl font-semibold px-2 lg:px-0">WishList</h1>
                            </div>
                            <div className="space-y-5 ">
